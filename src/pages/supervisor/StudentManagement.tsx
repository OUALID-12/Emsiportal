...
const StudentManagement = () => {
  ...
  const formatAbsenceCount = (student: any) => {
    ...
    const justified = student.justifiedAbsences || 0;
                ...
                <TableBody>
                  {filteredStudents.map((student) => (
                    <TableRow key={student.id}>
                      ...
                      <TableCell>Class {student.class || 'A'}</TableCell>
                  ...
                  .map(student => (
                    <div key={student.id} className="p-4 border rounded-md flex justify-between items-center">
                      <div>
                        ...
                        <div className="text-sm">ID: {student.studentId} | Class {student.class || 'A'}</div>
